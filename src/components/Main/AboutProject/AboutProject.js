  ...
  return (
    <section className="about-project" id="about-project">
      ...
      <div className="about-project__info">
        <h3 className="about-project__undertitle">
          Дипломный проект включал 5 этапов
        </h3>
        <h3 className="about-project__undertitle about-project__undertitle_type_last">
        ...
        <p className="about-project__text about-project__text_type-last">
